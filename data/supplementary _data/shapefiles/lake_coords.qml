...
<qgis styleCategories="AllStyleCategories" minScale="0" maxScale="0" version="3.16.3-Hannover" simplifyLocal="1" readOnly="0" labelsEnabled="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" toleranceUnit="MM" toleranceUnitScale="3x:0,0,0,0,0,0" tolerance="3" type="pointCluster">
      ...
      <symbols>
        <symbol force_rhr="0" name="0" alpha="1" clip_to_extent="1" type="marker">
          <layer class="SimpleMarker" locked="0" enabled="1" pass="0">
            ...
            <prop v="55,108,164,0" k="outline_color"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="lake" configurationFlags="None">
    ...
    <field name="long" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="0" type="QString"/>
  ...
  <aliases>
    <alias index="0" field="lake" name=""/>
    <alias index="1" field="lat" name=""/>
    <alias index="2" field="long" name=""/>
  </aliases>
  <defaults>
    <default field="lake" applyOnUpdate="0" expression=""/>
    <default field="lat" applyOnUpdate="0" expression=""/>
    <default field="long" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    <constraint field="lake" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="lat" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="long" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="lake" exp="" desc=""/>
    <constraint field="lat" exp="" desc=""/>
    <constraint field="long" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{2cc8e07b-72df-4660-8998-3b70351a4eb1}" key="Canvas"/>
    <actionsetting icon="" name="" isEnabledOnlyWhenEditable="0" id="{cecdef8e-5408-4287-90fc-f10cba83a845}" capture="0" action="" notificationMessage="" type="0" shortTitle="">
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="lake" width="-1" hidden="0" type="field"/>
    </columns>
